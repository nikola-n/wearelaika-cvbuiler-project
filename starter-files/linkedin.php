...
<body>
    ...
    <div class="container-fluid">
        <div class="col-md-8" style="margin-top:3%;" id="linkedInProfile">
            <div class="row">
                <button class="btn btn-3 text-uppercase" type="submit" id="cv">cv</button>
                <button class="btn btn-3 text-uppercase active" type="submit" id="linkedIn">linkedin</button>
                    ...
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="item active" id="img1">
                                <img src="img/LinkedIn/bill1.png" alt="pic1" class="img-responsive imgEdit">
                            </div>
                            <div class="item" id="img2">
                                <img src="img/LinkedIn/bill2.png" alt="pic2" class="img-responsive imgEdit">
                            </div>
                            <div class="item" id="img3">
                                <img src="img/LinkedIn/bill3.png" alt="pic3" class="img-responsive imgEdit">
                            </div>
                            <div class="item" id="img4">
                                <img src="img/LinkedIn/bill4.png" alt="pic4" class="img-responsive imgEdit">
                            </div>
                        </div>
        ...
        <div class="col-md-4 border-1" id="linke" style="width:30%; margin-top:11%; margin-left:3%;">
